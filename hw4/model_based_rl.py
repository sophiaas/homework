...
class ModelBasedRL(object):
    ...
    def __init__(self,
                 ...
                 num_onplicy_iters=50,
                 num_onpolicy_rollouts=50,
                 training_epochs=60,
    ...
    def run_q1(self):
        ...
        for r_num, (states, actions, _, _, _) in enumerate(self._random_dataset.rollout_iterator()):
            ...
            for i, a in enumerate(actions):
                state = self._policy.predict(pred_states[i], a)
                pred_states.append(state)
                print(i)
                print(state)
    ...
    def run_q3(self):
        ...
        for itr in range(self._num_onpolicy_iters + 1):
            ...
            new_dataset = self._gather_rollouts(self._policy, self._max_rollout_length)
